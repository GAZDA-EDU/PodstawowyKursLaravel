            ...
            <div class="col-lg-8 col-xl-7">
                <form action="{{ route('customers.store') }}" method="POST" id="contactForm">
                    ...
                    <div class="form-floating mb-3">
                        <input class="form-control" id="name" value="{{ old('name') }}" name="name" type="text" placeholder="Nazwa" data-sb-validations="required" />
                        <label for="name">Nazwa klienta</label>
                        <div class="invalid-feedback" data-sb-feedback="name:required">Wpisz nazwę klenta.</div>
                    </div>
                    <!-- Data input-->
                    <div class="form-floating mb-3">
                        <input class="form-control" id="address" value="{{ old('address') }}" name="address" type="text" placeholder="Adres" data-sb-validations="required" />
                        <label for="address">Adres</label>
                        <div class="invalid-feedback" data-sb-feedback="address:required">Wprowadź adres.</div>
                    </div>
                    <!-- Nip input-->
                    <div class="form-floating mb-3">
                        <input class="form-control" id="nip" value="{{ old('nip') }}" name="nip" type="text" placeholder="Numer NIP" data-sb-validations="required" />
