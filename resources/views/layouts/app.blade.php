...
<html lang="en">
    ...
    <body id="page-top">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        ...
                        <p class="lead mb-0">
                            Fakturomat to projekt demonstracyjny, oparty o
                            <a href="http://laravel.com">Laravela</a> umożliwiający wystawianie
                            faktur i dodawanie klientów.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="copyright py-4 text-center text-white">
            <div class="container"><small>Prawa autorskie &copy; Your Website 2024</small></div>
        </div>
